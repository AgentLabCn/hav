<<<<<<< HEAD:test/Case2_wealth_model.py
...
class validate_wealth_model():
    ...
    # Benchmark data used as a control reference in validation
    Benchmark = {
        'final_wealth': pd.read_csv('test/wealth_data/AgentBenchmark.csv')['final_wealth'].tolist(),
        'gini': pd.read_csv('test/wealth_data/ModelBenchmark.csv')['gini'].tolist(),
        'a_ratio': pd.read_csv('test/wealth_data/ModelBenchmark.csv')['a_ratio'].tolist(),
        'b_ratio': pd.read_csv('test/wealth_data/ModelBenchmark.csv')['b_ratio'].tolist(),
        'c_ratio': pd.read_csv('test/wealth_data/ModelBenchmark.csv')['c_ratio'].tolist(),
    }
    Benchmark.update({
        idx: pd.read_csv('test/wealth_data/ModelBenchmark.csv')[idx].tolist() 
        for idx in [f'{lv1}2{lv2}' for lv1 in ['a','b','c']  for lv2 in ['a','b','c']]
    })
...
if __name__ == '__main__':
    validate_wealth_model()
>>>>>>> b109080ea64999406e75f482f60b77d62eb1334f:test/wealth_model.py
