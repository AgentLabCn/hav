...
from .methods import causal_analysis, sentivity_analysis, surrogate_analysis, bayesian, ks_test, kurtosis_test, MSE, skewness_test, variance_test
from .utils import run_ABM, flatten
...
class Result: 
    ...
    def __init__(self, method, res, atts, details): 
        self.method = method
